...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("actual_report_path", sa.String(length=255), nullable=False),
        sa.Column("source_ied", sa.String(length=128), nullable=False),
        sa.Column("endpoint_id", sa.String(length=128), nullable=False),
        sa.Column("rpt_id", sa.String(length=255), nullable=False),
        ...
        sa.Column("source_report_sequence_generation", sa.Integer(), nullable=True),
        sa.Column("source_report_sequence_number", sa.Integer(), nullable=True),
        sa.Column("source_report_sub_sequence_number", sa.Integer(), nullable=True),
        sa.Column("report_reason", sa.String(length=64), nullable=True),
        sa.Column("signal_value", sa.JSON(), nullable=True),
        sa.Column("timestamp_summary", sa.JSON(), nullable=True),
