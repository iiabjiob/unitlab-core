...
WORKER_DEFINITIONS: tuple[WorkerDefinition, ...] = (
    ...
    WorkerDefinition(
        name="external_ied_availability",
        display_name="External IED Availability",
    ...
    WorkerDefinition(
        name="external_ied_planning",
        display_name="External IED Planning",
        impact="IEC 61850 Signal List to IED model matching is stale.",
    ),
    WorkerDefinition(
