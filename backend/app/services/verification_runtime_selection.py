...
class _ClientControlMmsRuntimeAdapter:
    ...
    def connect(
        ...
        *,
        ...
        if len(candidates) != 1:
            raise Iec61850ReportRuntimeError(
                "MMS_MULTI_CANDIDATE_NOT_SUPPORTED",
                "IEC 61850 MMS adapter currently supports exactly one report control per session.",
            )
...
class _ClientControlMmsSession:
    ...
    def _ensure_reference(self, reference: Iec61850ReportControlRef) -> None:
        if to_report_control_ref(self._candidate) != reference:
            raise Iec61850ReportRuntimeError(
    ...
    def _build_state(
        ...
        *,
        ...
        return Iec61850ReportControlState(
            ...
            enabled=self._enabled if enabled is None else enabled,
