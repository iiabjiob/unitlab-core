...
- Deterministic scripted and recorded transport helpers now exist for transport-oriented tests and parity capture, and an in-memory association helper exercises open/release/abort semantics. They are not wire MMS framing.
