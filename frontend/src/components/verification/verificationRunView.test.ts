  ...
  return {
    ...
    verification_run: {
      ...
      subscription_snapshots: [
        {
          subscription_id: "run-42:group-1",
          session_id: "run-42:sim:DO-002/unknown",
          endpoint_id: "sim:DO-002/unknown",
          group_id: "group-1",
          report_control_reference: "brcbA",
          report_control_name: "brcbA",
          data_set_reference: "ds-a",
          subscription_state: "reporting",
          report_health: "healthy",
          last_report_at: "2026-06-24T10:11:13.070000Z",
          current_rptena_owner: "unitlab-backend-simulator",
      ...
      verification_steps: [
        {
          ...
          source_subscription_id: "run-42:group-1",
          source_generation: 1,
