  ...
  <div class="switchgear-sld-package-canvas__toolbar" role="toolbar" aria-label="Single line diagram editor">
    <div class="switchgear-sld-package-canvas__actions">
      <div class="switchgear-sld-package-canvas__tool-tabs" role="group" aria-label="Canvas tool">
        ...
        <SldToolbarButton size="xs" variant="toolbar" class="switchgear-sld-package-canvas__tool-tab" :class="{ 'is-active': props.activeTool === 'line' }" :aria-pressed="props.activeTool === 'line'" title="Draw a line (L)" aria-label="Line tool" @click="props.actions.setTool('line')">╱</SldToolbarButton>
      </div>
      ...
      <div v-if="props.selectedNodeCount > 1" class="switchgear-sld-package-canvas__tool-tabs">
        <SldToolbarButton size="xs" variant="toolbar" title="Align selected switchgears to the left" aria-label="Align left" @click="props.actions.align('left')">⇐</SldToolbarButton>
        <SldToolbarButton size="xs" variant="toolbar" title="Align selected switchgears to the top" aria-label="Align top" @click="props.actions.align('top')">⇑</SldToolbarButton>
        <SldToolbarButton size="xs" variant="toolbar" title="Align selected switchgears to the right" aria-label="Align right" @click="props.actions.align('right')">⇒</SldToolbarButton>
        <SldToolbarButton size="xs" variant="toolbar" title="Align selected switchgears to the bottom" aria-label="Align bottom" @click="props.actions.align('bottom')">⇓</SldToolbarButton>
      </div>
      <div class="switchgear-sld-package-canvas__tool-tabs">
        <SldToolbarButton size="xs" variant="toolbar" :class="{ 'switchgear-sld-package-canvas__snap-toggle--active': props.snapEnabled }" :title="props.snapEnabled ? 'Disable magnetic snap' : 'Enable magnetic snap'" :aria-label="props.snapEnabled ? 'Disable magnetic snap' : 'Enable magnetic snap'" @click="props.actions.toggleSnap">⌁</SldToolbarButton>
      ...
      <SldToolbarButton size="xs" variant="toolbar" title="Arrange switchgears automatically" aria-label="Auto layout" @click="props.actions.autoArrange">⤢</SldToolbarButton>
