...
<template>
  <g class="switchgear-sld-node-symbol switchgear-sld-node-symbol--earthing" fill="none" stroke-linecap="round" stroke-linejoin="round" :stroke-dasharray="props.unconfigured ? '4 3' : undefined">
