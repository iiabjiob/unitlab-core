...
<template>
  <g class="switchgear-sld-node-symbol switchgear-sld-node-symbol--disconnector" :class="{ 'switchgear-sld-node-symbol--selected': props.selected }" fill="none" stroke-linecap="round" stroke-linejoin="round">
