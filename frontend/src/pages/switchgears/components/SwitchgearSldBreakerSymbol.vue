...
<template>
  <g class="switchgear-sld-node-symbol switchgear-sld-node-symbol--breaker" :class="{ 'switchgear-sld-node-symbol--selected': props.selected }" :stroke-dasharray="props.unconfigured ? '4 3' : undefined">
