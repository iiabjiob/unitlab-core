...
def load_config() -> AgentConfig:
    ...
    pid = os.getpid()
    return AgentConfig(
        redis_url=os.getenv("UNITLAB_CORE_DIAG_AGENT_REDIS_URL", "redis://127.0.0.1:6379/0"),
        redis_command_stream=os.getenv("UNITLAB_CORE_DIAG_AGENT_COMMAND_STREAM", "core_diag:commands"),
        redis_event_stream=os.getenv("UNITLAB_CORE_DIAG_AGENT_EVENT_STREAM", "core_diag:events"),
        redis_state_key=os.getenv("UNITLAB_CORE_DIAG_AGENT_STATE_KEY", "core_diag:state"),
