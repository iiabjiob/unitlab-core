...
typedef struct {
    ...
    size_t last_report_unsupported_value_count;
    size_t gva_success_count;
    size_t gva_failed_count;
    size_t typed_leaf_count;
    size_t unsupported_type_count;
    size_t skipped_branch_count;
    size_t max_depth_seen;
    size_t array_count;
    size_t quality_like_count;
    size_t timestamp_like_count;
...
typedef struct {
    ...
    char type_kind[32U];
    char node_kind[32U];
    char decode_status[32U];
    uint8_t raw_tag_class;
    uint32_t raw_tag_number;
    int raw_constructed;
    size_t raw_length;
    size_t type_width;
    int supported;
