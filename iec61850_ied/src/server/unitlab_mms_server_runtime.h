...
#define UNITLAB_MMS_SERVER_RUNTIME_WIRE_SCRATCH_LENGTH 65535U
#define UNITLAB_MMS_SERVER_RUNTIME_MAX_SIGNAL_VALUES 4096U
#define UNITLAB_MMS_SERVER_RUNTIME_SIGNAL_VALUE_LENGTH 128U
#define UNITLAB_MMS_SERVER_RUNTIME_MAX_PENDING_REPORTS 8U
#define UNITLAB_MMS_SERVER_RUNTIME_MAX_REPORT_MEMBERS 512U
