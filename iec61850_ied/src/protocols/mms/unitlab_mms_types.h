...
typedef enum UnitLabMmsDiagnosticCode {
    ...
    UNITLAB_MMS_DIAGNOSTIC_RCB_NOT_DISABLED = 12,
    UNITLAB_MMS_DIAGNOSTIC_RCB_NOT_RESERVED = 13,
    UNITLAB_MMS_DIAGNOSTIC_RCB_NOT_ENABLED = 14
...
typedef enum UnitLabMmsRuntimeEventKind {
    ...
    UNITLAB_MMS_RUNTIME_EVENT_REQUEST_CORRELATION_MISMATCH = 16,
    ...
    UNITLAB_MMS_RUNTIME_EVENT_SESSION_RELEASED = 17
