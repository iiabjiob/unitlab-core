...
- Fixture-based native report decoder test now builds a model-backed GI `InformationReport` and validates DataRef/value/reason mapping plus zero-mismatch diagnostics without requiring a fresh pcap.
